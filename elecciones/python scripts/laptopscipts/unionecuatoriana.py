...
try:
    ...
    db = server.create('unionecuatoriana3')
except:
...
twitterStream.filter(track=['unionecuatoriana','washingtonpesantez','lista19','votatodo19','washingtonpresidente','pesantezpresidente'])
