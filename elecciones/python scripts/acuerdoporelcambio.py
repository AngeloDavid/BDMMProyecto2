...
try:
    ...
    db = server.create('acuerdoporelcambio2')
except:
...
twitterStream.filter(track=['acuerdoporelcambio','pacomoncayo','lista2','lista12','lista18','votatodo2','votatodo12','votatodo18','pacopresidente','moncayopresidente'])
